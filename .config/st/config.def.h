/* primary font */
static char *font = "FiraCode Nerd Font:pixelsize=18.5:antialias=true:autohint=true:style=Medium";
...
static char *openurlcmd[] = { "/bin/sh", "-c", "st-linkhandler -o", "externalpipe", NULL };
static char *copyurlcmd[] = { "/bin/sh", "-c", "st-linkhandler -c", "externalpipe", NULL };
